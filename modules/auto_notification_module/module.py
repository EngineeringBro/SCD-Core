...
All decisions (field IDs, assignees, resolution, confidence) are in profiles/:
  profiles/revv_error_v1.py      — topic 10494 (Revv Error Report)
  profiles/auto_notif_v1.py      — topic 10404 (Automatic Notifications)
  profiles/assurant_email_v1.py  — reporter @assurant.com
